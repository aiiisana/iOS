...
iOS-клиент для работы с базой **OMDb API**. Реализация кастомного интерфейса на чистом UIKit без использования сторибордов.

## 🛠 Tech Stack
* **UI:** UIKit (Programmatic), Compositional Layout.
* **Network:** REST API, URLSession, Kingfisher (image caching).
